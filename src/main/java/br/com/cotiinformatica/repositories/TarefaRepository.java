...
public class TarefaRepository implements ITarefaRepository{
	...
	public void create(Tarefa tarefa) throws Exception {
        ...
        PreparedStatement statement = connection.prepareStatement("insert into tarefa(nome, descricao, data, hora, prioridade, idusuario) values(?, ?, ?, ?, ?, ?)");
	...
	public void update(Tarefa tarefa) throws Exception {
        ...
        //Executar o o comando de update no banco de dados
        PreparedStatement statement = connection.prepareStatement("update tarefa set nome=?, data=?, hora=?, prioridade=?,descricao=? where idtarefa=? and idusuario=?");
        statement.setString(1, tarefa.getNome());
	...
	public void delete(Tarefa tarefa) throws Exception {
        ...
        //Executar o o comando de update no banco de dados
        PreparedStatement statement = connection.prepareStatement("delete from tarefa where idtarefa=? and idusuario=?");
	...
	public List<Tarefa> findAll(String nome, Integer idUsuario) throws Exception {
        ...
        PreparedStatement statement = connection.prepareStatement("select * from tarefa where nome like ? and idusuario=?");
