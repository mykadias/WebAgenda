        ...
        <form id="formEdicao" action="atualizar-tarefa" method="post">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-2">
                    ...
                    <form:input path="model.data" type="date" id="data" name="data" class="form-control"/>
                </div>
                <div class="col-md-2">
                    <label>Hora da tarefa:</label>
                    <form:input path="model.hora" type="time" id="hora" name="hora" class="form-control"/>
                </div>
                <div class="col-md-2">
            ...
            <div class="row mb-3">
                <div class="col-md-12">
                    ...
                    <form:textarea path="model.descricao" class="form-control" id="descricao" name="descricao" rows="4" placeholder="Digite aqui"></form:textarea>
                </div>
            </div>
